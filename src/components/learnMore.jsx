...
const LearnMore = () => {
  return (
    <>
      <div className="w-4/5 md:w-1/2 flex flex-col justify-center items-center gap-8 text-center mt-10 md:mt-0">
        <h2 className="text-blue-400 flex gap-2 bg-blue-950 px-2 py-1 rounded-2xl text-sm md:text-md"><i class="bi bi-stars text-sm md:text-md"></i>Why Choose Us</h2>
        <h3 className="text-2xl md:text-4xl text-gray-100 font-medium">Features Designed For Your Success</h3>
        <p className="text-md md:text-lg text-gray-400 font-normal">Everything you need to create professional, standout resumes that get noticed by recruiters.</p>
      </div>
      <div className=" w-4/5 flex justify-between items-center flex-wrap flex-col md:flex-row gap-10">
        <div className="w-full md:w-3/11 bg-gray-950 p-6 rounded-2xl flex flex-col gap-8 border border-gray-800 hover:bg-gray-900">
